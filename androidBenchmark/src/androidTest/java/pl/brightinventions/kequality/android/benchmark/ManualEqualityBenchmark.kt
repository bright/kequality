...
class ManualEqualityBenchmark {
    ...
    fun compareCustomer1ToCustomer2() {
        benchmarkRule.measureRepeated {
            CustomerManualEquality.areEqual(Customer1, Customer2)
        }
    }
    ...
    fun compareCustomer3ToSelf() {
        benchmarkRule.measureRepeated {
            CustomerManualEquality.areEqual(Customer3, Customer3)
        }
    }
    ...
    fun compareListOf100Customer3ToSelf() {
        benchmarkRule.measureRepeated {
            ListEquality(CustomerManualEquality, ignoreOrder = false).areEqual(

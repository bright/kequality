...
class DelegatingEqualityBenchmark {
    ...
    fun compareCustomer1ToCustomer2() {
        benchmarkRule.measureRepeated {
            CustomerDelegatingEquality.areEqual(Customer1, Customer2)
        }
    }
    ...
    fun compareCustomer3ToSelf() {
        benchmarkRule.measureRepeated {
            CustomerDelegatingEquality.areEqual(Customer3, Customer3)
        }
    }
    ...
    fun compareListOf100Customer3ToSelf() {
        benchmarkRule.measureRepeated {
            ListEquality(CustomerDelegatingEquality, ignoreOrder = false).areEqual(

...
class PropertyEqualityBenchmark {
    ...
    fun compareCustomer1ToCustomer2() {
        benchmarkRule.measureRepeated {
            CustomerPropertyEquality.areEqual(Customer1, Customer2)
        }
    }
    ...
    fun compareCustomer3ToSelf() {
        benchmarkRule.measureRepeated {
            CustomerPropertyEquality.areEqual(Customer3, Customer3)
        }
    }
    ...
    fun compareListOf100Customer3ToSelf() {
        benchmarkRule.measureRepeated {
            ListEquality(CustomerPropertyEquality, ignoreOrder = false).areEqual(
